...
m4_define( [QUOTE_COMMA], [m4_patsubst( [$1], [,], [[[,]]])]) [ prerequisite for comma problem, best solution]
...
m4_syscmd( [echo -n ]MACRO_TO_CMDLINE1( m4_defn( [MACRO_TO_EXPAND]))[ >work/cmpfile1])
m4_syscmd( [echo -n ]MACRO_TO_CMDLINE2( m4_defn( [MACRO_TO_EXPAND]))[ >work/cmpfile2])
m4_syscmd( [echo -n ]MACRO_TO_CMDLINE3( m4_defn( [MACRO_TO_EXPAND]))[ >work/cmpfile3])

m4_syscmd( [echo -n ]MACRO_TO_CMDLINE1( [$USER \ , """ '''])[ >work/cmpfile0])
...
test( equal( [$USER \ , """ '''], INCLUDE_NOT_EXPANDING( [work/cmpfile0])))
